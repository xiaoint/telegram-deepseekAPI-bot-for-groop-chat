...
A sophisticated Telegram bot with dual personalities powered by DeepSeek AI, featuring advanced memory management, whitelist security, and adaptive behavior modes.
...
- **Reply Context Tracking**: Understands message threads and conversations
...
```bash
git clone https://github.com/yourusername/enhanced-raiden-bot.git
cd enhanced-raiden-bot
```
...
```env
WHITELIST_ENABLED=true
WHITELIST_USERS=dad_id,mom_id,@sister,brother_id
...
├── whitelist_readme.md   # Whitelist documentation
...
- Inspired by Raiden Ei from Genshin Impact
...
**Ready to deploy your Enhanced Raiden Bot!** ⚡🤖